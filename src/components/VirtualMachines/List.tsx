              ...
              <MenuItem
                onClick={async () => {
                  ...
                  try {
                    ...
                    enqueueSnackbar(`Failed to force stop VM ${item.getName()}: ${e}`, { variant: 'error' });
                  }
                }}
                disabled={isDisabled}
              >
              ...
              <MenuItem
                onClick={async () => {
                  ...
                  try {
                    ...
                    enqueueSnackbar(`Failed to restart VM ${item.getName()}: ${e}`, { variant: 'error' });
                  }
                }}
                disabled={isDisabled}
              >
              ...
              <MenuItem
                onClick={async () => {
                  ...
                  try {
                    ...
                    enqueueSnackbar(`Failed to ${isPaused ? 'unpause' : 'pause'} VM ${item.getName()}: ${e}`, { variant: 'error' });
                  }
                }}
                disabled={isDisabled}
              >
              ...
              <MenuItem
                onClick={async () => {
                  ...
                  try {
                    ...
                    enqueueSnackbar(`Failed to migrate VM ${item.getName()}: ${e}`, { variant: 'error' });
                  }
                }}
                disabled={isDisabled}
              >
                  ...
                  <Tooltip
                    title={
                      <div style={{ fontSize: '0.875rem' }}>
                        <strong>Not Migratable</strong><br />
